...
class EventDispatcher implements IEventDispatcher {
    ...
    @:noCompletion private var __eventMap:Map<String, Slice<Listener>>;
    @:noCompletion private var __iterators:Map<String, Slice<DispatchIterator>>;
    ...
    public function addEventListener(type:String, listener:Dynamic -> Void, useCapture:Bool = false, priority:Int = 0):Void {
        ...
        if (!__eventMap.exists(type)) {
            ...
            var iterators:Slice<DispatchIterator> = __iterators.get(type);
    ...
    public function removeEventListener(type:String, listener:Dynamic -> Void, useCapture:Bool = false):Void {
        ...
        var count:Int = 0;
        for (listenerArray in __eventMap) {
    ...
    @:noCompletion private function __addListenerByPriority(list:Slice<Listener>, listener:Listener):Void {
...
@:keep
private class DispatchIterator {

    public var active:Bool;
    public var index (default, null):Int;

    @:noCompletion private var isCopy:Bool;
    @:noCompletion private var list:Slice<Listener>;


    public function new(list:Slice<Listener>) {
    ...
    public function reset(list:Slice<Listener>):Void {
...
private class Listener {
    ...
    public function match(callback:Dynamic -> Void, useCapture:Bool) {
        ...
        // gml 没有反射
        return callback == this.callback && this.useCapture == useCapture;
    }
